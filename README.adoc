...
image:https://img.shields.io/badge/release-0.0.6-green.svg[release, link=https://plugins.gradle.org/plugin/io.vertx.vertx-plugin]
...
And to all the contributors of this project.
